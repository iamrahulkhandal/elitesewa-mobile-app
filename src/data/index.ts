...
export const TOP_PLACES = [
  {
    id: 1,
    image: require('../../assets/images/TopPlacesCarousel/Daily_car_wash.jpg'),
    title: 'Amalfi Coast',
    location: 'Italy',
    description:
  ...
  {
    id: 4,
    image: require('../../assets/images/TopPlacesCarousel/daily_bike_wash.jpg'),
    title: 'Granada',
    location: 'Spain',
    description:
  ...
  {
    id: 6,
    image: require('../../assets/images/TopPlacesCarousel/car_pick_drop.jpg'),
